...
async def get_mentor_by_id(mentor_id: str, current_user = Depends(get_current_user)):
    ...
    try:
        ...
        # Return ALL mentor details fields
        mentor_data = {
            "mentor_details": {
                "user_id": mentor.get("user_id"),
                ...
                "current_residence": mentor.get("current_residence"),
                "taken_standardized_tests": mentor.get("taken_standardized_tests"),
                "standardized_tests_taken": mentor.get("standardized_tests_taken"),
                "test_scores": mentor.get("test_scores"),
                "taken_english_tests": mentor.get("taken_english_tests"),
                "english_tests_taken": mentor.get("english_tests_taken"),
                "english_test_scores": mentor.get("english_test_scores"),
                "self_application": mentor.get("self_application"),
                "education_funding": mentor.get("education_funding"),
                "other_universities_admitted": mentor.get("other_universities_admitted"),
                "work_experience_years": mentor.get("work_experience_years"),
                "current_status": mentor.get("current_status"),
                "current_designation": mentor.get("current_designation"),
                "industries_worked": mentor.get("industries_worked"),
                "companies_worked": mentor.get("companies_worked"),
                "hobbies": mentor.get("hobbies"),
                "self_description": mentor.get("self_description"),
                "how_can_help": mentor.get("how_can_help"),
                "mentorship_fee": mentor.get("mentorship_fee"),
                "currency": mentor.get("currency"),
                ...
                "community_referral": mentor.get("community_referral"),
